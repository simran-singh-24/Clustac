		...
		<div class="menu">
			...
			<div class="rightmenu">
				<ul>
					...
					<a href="./allcourses.php"><li> All Courses</li></a>
					<a href=""><li> Aboust us</li></a>
                    <a href=""><li>contact</li></a>
                    <li  id="fisrtlist" class="profile-drop"><?php echo $firstname." ". $lastname; ?><span><i class="fa fa-user-circle-o" style="font-size:24px;padding: 7px;"></i></span></li>
				</ul>
			</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="profile-head">
                                    ...
                                    <p class="proile-rating">RANKINGS : <span>5/10</span></p>
